...
#define	BF_MIN_KEY_LEN		32	/* Blowfish min key length in bits */
#define	BF_MAX_KEY_LEN		448	/* Blowfish max key length in bits */
...
static crypto_mech_info_t dprov_mech_info_tab[] = {
	...
	{SUN_CKM_BF_CBC, BF_CBC_MECH_INFO_TYPE,
	    ...
	    CRYPTO_FG_MAC_DECRYPT | CRYPTO_FG_ENCRYPT_ATOMIC |
	    CRYPTO_FG_DECRYPT_ATOMIC | CRYPTO_FG_ENCRYPT_MAC_ATOMIC |
	    CRYPTO_FG_MAC_DECRYPT_ATOMIC, BF_MIN_KEY_LEN, BF_MAX_KEY_LEN,
	    CRYPTO_KEYSIZE_UNIT_IN_BITS},
	/* BF-ECB */
	{SUN_CKM_BF_ECB, BF_ECB_MECH_INFO_TYPE,
	    ...
	    CRYPTO_FG_DECRYPT_ATOMIC | CRYPTO_FG_ENCRYPT_MAC_ATOMIC |
	    CRYPTO_FG_MAC_DECRYPT_ATOMIC,
	    BF_MIN_KEY_LEN, BF_MAX_KEY_LEN, CRYPTO_KEYSIZE_UNIT_IN_BITS},
	/* AES-CBC */
...
dprov_valid_cipher_mech(crypto_mech_type_t mech_type)
{
	return (mech_type == DES_CBC_MECH_INFO_TYPE ||
		...
		mech_type == BF_CBC_MECH_INFO_TYPE ||
		mech_type == BF_ECB_MECH_INFO_TYPE ||
