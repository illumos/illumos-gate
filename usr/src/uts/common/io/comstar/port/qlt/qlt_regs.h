...
#define	HCCR_CMD_SET_RISC_RESET			0x10000000
#define	HCCR_CMD_CLEAR_RISC_RESET		0x20000000
#define	HCCR_CMD_SET_RISC_PAUSE			0x30000000
#define	HCCR_CMD_CLEAR_RISC_PAUSE		0x40000000
