...
typedef	struct	dadk_errstats {
	struct kstat_named dadk_softerrs;	/* Collecting Softerrs */
	struct kstat_named dadk_harderrs;	/* Collecting harderrs */
	struct kstat_named dadk_transerrs;	/* Collecting Transfer errs */
	struct kstat_named dadk_model;		/* model # of the disk */
	struct kstat_named dadk_revision;	/* The disk revision */
	struct kstat_named dadk_serial;		/* The disk serial number */
	struct kstat_named dadk_capacity;	/* Capacity of the disk */
	struct kstat_named dadk_rq_media_err;	/* Any media err seen */
	struct kstat_named dadk_rq_ntrdy_err;	/* Not ready errs */
	struct kstat_named dadk_rq_nodev_err;	/* No device errs */
	struct kstat_named dadk_rq_recov_err;	/* Recovered errs */
	struct kstat_named dadk_rq_illrq_err;	/* Illegal requests */
} dadk_errstats_t;
