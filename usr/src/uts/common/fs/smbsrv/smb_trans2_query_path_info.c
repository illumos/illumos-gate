...
smb_com_trans2_query_path_information(struct smb_request *sr, struct smb_xa *xa)
{
	...
	short_name = kmem_zalloc(MAXNAMELEN, KM_SLEEP);
	name83 = kmem_zalloc(MAXNAMELEN, KM_SLEEP);
	...
	case SMB_QUERY_FILE_ALT_NAME_INFO:
		 ...
		 *
		 * The short_name may have already been generated by
		 * smb_fsop_lookup().  If not, call smb_mangle_name().
