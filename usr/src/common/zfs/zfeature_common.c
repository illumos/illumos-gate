...
zpool_feature_init(void)
{
	...
	/* Slot for SPA_FEATURE_REDACTION_BOOKMARKS */

	/* Slot for SPA_FEATURE_REDACTED_DATASETS */

	/* Slot for SPA_FEATURE_BOOKMARK_WRITTEN */
...

	{
		...
		zfeature_register(SPA_FEATURE_OBSOLETE_COUNTS,
		    ...
		    "Reduce memory used by removed devices when their "
		    "blocks are freed or remapped.",
		    ZFEATURE_FLAG_READONLY_COMPAT, ZFEATURE_TYPE_BOOLEAN,
