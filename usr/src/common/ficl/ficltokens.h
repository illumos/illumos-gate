	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionSemiParen, "(;)",
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionGreaterThan, ">",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionUGreaterThan, "u>",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionBranchParen, "(branch-final)",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionBranch0ParenWithCheck,
	    "(branch0)", FICL_WORD_COMPILE_ONLY)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionLoopParen, "(loop)",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionOfParen, "(of)",
	    FICL_WORD_COMPILE_ONLY)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionCellPlus, "cell+",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionNegate, "negate",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionStarSlash, "*/",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionSlashMod, "/mod",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionStarSlashMod, "*/mod",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionDoDoes, "** do-does **",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionDoParen, "(do)",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionDoesParen, "(does)",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionQDoParen, "(?do)",
	    FICL_WORD_COMPILE_ONLY)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionPlusStore, "+!",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionFromRStack, "r>",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionFetchRStack, "r@",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstruction2ToR, "2>r",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstruction2RFrom, "2r>",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstruction2RFetch, "2r@",
	    FICL_WORD_COMPILE_ONLY)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionToRStack, ">r",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionQuestionDup, "?dup",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionMinusRoll, "-roll",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionMinusRot, "-rot",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionQuadFetch, "q@",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionQuadStore, "q!",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionInvert, "invert",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionLShift, "lshift",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionRShift, "rshift",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionCompare, "compare",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionCompareInsensitive,
	    "compare-insensitive", FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionRandom, "random",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionSeedRandom, "seed-random",
	    FICL_WORD_DEFAULT)

	FICL_INSTRUCTION_TOKEN(ficlInstructionLeave, "leave",
	    FICL_WORD_COMPILE_ONLY)
	FICL_INSTRUCTION_TOKEN(ficlInstructionUnloop, "unloop",
	    FICL_WORD_COMPILE_ONLY)

#if FICL_WANT_USER
	FICL_INSTRUCTION_TOKEN(ficlInstructionUserParen, "(user)",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionFNegate, "fnegate",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionFFrom, "float>",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionFPlusStore, "f+!",
	    FICL_WORD_DEFAULT)

	FICL_INSTRUCTION_TOKEN(ficlInstructionFDrop, "fdrop", FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionF2Drop, "f2drop",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionFMinusRoll, "f-roll",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionFMinusRot, "f-rot",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionFQuestionDup, "f?dup",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionFOver, "fover", FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionF2Over, "f2over",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionF2Swap, "f2swap",
	    FICL_WORD_DEFAULT)
	...
	FICL_INSTRUCTION_TOKEN(ficlInstructionF0Equals, "f0=",
	    FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionFEquals, "f=", FICL_WORD_DEFAULT)
	FICL_INSTRUCTION_TOKEN(ficlInstructionF0Greater, "f0>",
	    FICL_WORD_DEFAULT)
