...
origin_carc_setting=$(get_tunable zfs_compressed_arc_enabled)
...
function cleanup
{
	...
	log_must set_tunable64 zfs_compressed_arc_enabled $origin_carc_setting
}
log_onexit cleanup
...
log_must zpool create -O compression=lz4 -f $TESTPOOL-l2arc $VDEV \
    cache $VDEV_CACHE
