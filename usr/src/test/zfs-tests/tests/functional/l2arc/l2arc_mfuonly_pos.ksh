...
function cleanup
{
	...
	log_must set_tunable32 zfs_prefetch_disable $zfsprefetch
}
log_onexit cleanup
...
typeset zfsprefetch=$(get_tunable zfs_prefetch_disable)
log_must set_tunable32 zfs_prefetch_disable 1
