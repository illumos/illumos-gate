...
function cleanup
{
	...
	log_must set_tunable32 zfs_trim_txg_batch $trim_txg_batch
	log_must set_tunable32 zfs_vdev_min_ms_count $vdev_min_ms_count
}
log_onexit cleanup
...
log_must set_tunable32 zfs_trim_txg_batch 8
...
log_must set_tunable32 zfs_vdev_min_ms_count 32
