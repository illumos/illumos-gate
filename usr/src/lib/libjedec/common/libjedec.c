 ...
 * as defined in JEP-106 BH (September 2023). The vendor code is encoded as a
...
static const libjedec_vendor_pair_t libjedec_vendors_12[LIBJEDEC_TABLE_SIZE] = {
	...
	{ 0xB6, "Zyzyx" },
	{ 0x37, "T-HEAD Semiconductor Co Ltd" },
...
static const libjedec_vendor_pair_t libjedec_vendors_15[112] = {
	{ 0x01, "Kalray SA" },
	...
	{ 0xD9, "Shenzhen Hippstor Technology Co Ltd" },
	{ 0xDA, "SSCT" },
