		...
		for (; n > 1; n--) {
			...
			if (ax0 < 0x00800000) {
				...
				if ((ax0 & 0x7fffffff) == 0) { /* |X| = zero */
					...
					tbl_div0 = ((double *)
					    ((char *)__TBL_rsqrtf + si0))[0];
					tbl_sqrt0 = ((double *)
					    ((char *)__TBL_rsqrtf + si0))[1];
					iax0 = ax0 & 0x7ffe0000;
					iax0 = ax0 - iax0;
					xx0 = iax0 * tbl_div0;
					res0 = tbl_sqrt0 *
			...
			*py = FONE / res;
			...
			if ((ax0 & 0x7fffffff) == 0) {	/* |X| = zero	*/
				*py = FONE / res;
				...
				tbl_div0 = ((double *)((char *)__TBL_rsqrtf +
				    si0))[0];
				tbl_sqrt0 = ((double *)((char *)__TBL_rsqrtf +
				    si0))[1];
				iax0 = ax0 & 0x7ffe0000;
				iax0 = ax0 - iax0;
				xx0 = iax0 * tbl_div0;
