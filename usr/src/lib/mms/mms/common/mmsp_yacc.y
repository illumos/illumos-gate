...
%token	ACTIVATE ENABLE DISABLE UNMOUNT NOTIFY
...
%token	PRESENT ONLINE OFFLINE SHAPEPRIORITY DENSITYPRIORITY MOUNTPOINT
...
mountpoint_clause
	: MOUNTPOINT
		{
			MMS_PAR_CHK_DUP(MOUNTPOINT);
		}
	 '[' str_arg_list ']'
		{
			MMS_PAR_ALLOC_NODE($$.nodep, "mountpoint",
			    MMS_PN_CLAUSE);
