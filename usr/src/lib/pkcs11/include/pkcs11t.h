...
/*
 * These conflict w/ definitions in usr/src/crypto/common and are deprecated,
 * so we will require clients to explicitly request their use.
 */
#ifdef PKCS11_DEPRECATED_PARAMS
