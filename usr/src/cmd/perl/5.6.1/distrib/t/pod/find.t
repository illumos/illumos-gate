...
#
# This test has been removed for ON because it finds SCCS directories in ON that
# aren't present in a stock 5.6.1 build directory and therfore fails.
# 
ok(1);	# Just pretend the test worked.
