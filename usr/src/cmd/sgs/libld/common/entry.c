...
static Sg_desc sg_desc[LD_NUM] = {
	...
	{{PT_SUNWCAP, PF_R, 0, 0, 0, 0, 0, 0},
		MSG_ORIG(MSG_ENT_SUNWCAP), 0, 0, {NULL, NULL}, {NULL, NULL},
		(FLG_SG_TYPE | FLG_SG_FLAGS), NULL, 0, 0},
	...
	{{PT_SUNWDTRACE, M_DATASEG_PERM | PF_X, 0, 0, 0, 0, 0, 0},
		MSG_ORIG(MSG_ENT_DTRACE), 0, 0, {NULL, NULL}, {NULL, NULL},
		(FLG_SG_TYPE | FLG_SG_FLAGS), NULL, 0, 0},
	{{PT_NOTE, 0, 0, 0, 0, 0, 0, 0},
		MSG_ORIG(MSG_ENT_NOTE), 0, 0, {NULL, NULL}, {NULL, NULL},
		FLG_SG_TYPE, NULL, 0, 0},
	{{PT_SUNWBSS, 0, 0, 0, 0, 0, 0, 0},
		MSG_ORIG(MSG_ENT_SUNWBSS), 0, 0, {NULL, NULL}, {NULL, NULL},
		FLG_SG_TYPE, NULL, 0, 0},
	{{PT_TLS, PF_R, 0, 0, 0, 0, 0, 0},
		MSG_ORIG(MSG_ENT_TLS), 0, 0, {NULL, NULL}, {NULL, NULL},
		(FLG_SG_TYPE | FLG_SG_FLAGS), NULL, 0, 0},
#if	defined(__i386) || defined(__amd64)
	{{PT_SUNW_UNWIND, PF_R, 0, 0, 0, 0, 0, 0},
		MSG_ORIG(MSG_ENT_UNWIND), 0, 0, {NULL, NULL}, {NULL, NULL},
		(FLG_SG_TYPE | FLG_SG_FLAGS), NULL, 0, 0},
#endif
