...
#ifndef	__FreeBSD__
/*
 * This is better than the number of ifdef blocks that would be otherwise
 * required throughout this code. Hopefully upstream will clear up the
 * char* /uint8_t * confusion.
 */
